...
public class SaveController implements ControllerV2 {
    @Override
    public View process(HttpServletRequest request, HttpServletResponse response) throws IOException {
...
//        System.out.println("member = " + member);
            ...
            //3. 적절한 페이지로  리다이렉트
//            response.sendRedirect("/chap02/v1/show"); //포워드
        return new View("redirect:/chap02/v2/show"); //리다이렉트
    }
