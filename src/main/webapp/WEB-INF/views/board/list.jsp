...
<%--&lt;%&ndash;  리스트에 있는 걸 모두 해당 html로 감싼 뒤, 보여주기&ndash;%&gt;--%>
...
<%--  </div>--%>
<%--    &lt;%&ndash; end div.card-wrapper&ndash;%&gt;--%>
<%--  </c:forEach>--%>
...
<%--  </div>--%>
<%--&lt;%&ndash;  <!— end div.bottom-section —>&ndash;%&gt;--%>

<%--</div>--%>
<%--&lt;%&ndash; end div.wrap&ndash;%&gt;--%>
...
<%--&lt;%&ndash;하나의 카드에만 script 적용되는 문제해결&ndash;%&gt;--%>
<%--&lt;%&ndash;1. 카드 전체에 eventListener 함수 적용되도록 변경&ndash;%&gt;--%>
<%--&lt;%&ndash;2. 버튼 누르는 이벤트리스너 함수 forEach($cardContainer =>) 로 nodeList 형식에 맞게 배열순회 적용하여 이벤트 추가&ndash;%&gt;--%>

<%--&lt;%&ndash;하나의 동일한 카드 디자인이 세로로 추가되는 문제해결&ndash;%&gt;--%>
